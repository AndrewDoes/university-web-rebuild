        ...
        <aside className="w-72 bg-sidebar-bg text-sidebar-foreground fixed inset-y-0 left-0 z-50 flex flex-col border-r border-border/50 font-sans shadow-lg transition-colors">
            ...
            <nav className="flex-1 px-4 py-8 space-y-1.5 overflow-y-auto">
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            key={item.id}
                            href={item.href}
                            className={`w-full flex items-center justify-between px-4 py-3.5 rounded-lg transition-all duration-300 group relative overflow-hidden no-underline border border-transparent ${
                                isActive
                ...
                <div className="pt-8 mt-8 border-t border-border/50 space-y-1.5">
                    ...
                    <Link
                        href="/settings"
                        className={`w-full flex items-center gap-4 px-4 py-3.5 rounded-lg transition-all no-underline border border-transparent ${
                            pathname === '/settings'
                                ? 'bg-muted text-foreground border-border'
                                : 'text-muted-foreground hover:text-foreground hover:bg-muted/30'
                        }`}
                    >
                        <Settings size={20} className={pathname === '/settings' ? 'text-primary' : 'text-muted-foreground'} />
