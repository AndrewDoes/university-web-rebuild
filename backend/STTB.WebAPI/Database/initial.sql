...
INSERT INTO lecturers (name, position, description, photo) VALUES
('Dr. Samuel Wijaya, M.Th.', 'Ketua Program Studi Teologi', 'Pakar dalam bidang teologi sistematik dan hermeneutika alkitab.', '/images/lecturers/samuel.jpg'),
('Pdt. Daniel Gunawan, M.Div.', 'Dosen Homiletics', 'Berpengalaman dalam pelayanan gereja selama lebih dari 20 tahun.', '/images/lecturers/daniel.jpg'),
('Dr. Maria Susanti, M.Th.', 'Dosen Perjanjian Baru', 'Spesialis studi Perjanjian Baru dan bahasa Yunani.', '/images/lecturers/maria.jpg'),
('Pdt. Jonathan Hartono, S.Th.', 'Dosen Pastoral', 'Berpengalaman dalam konseling pastoral dan pengembangan jemaat.', '/images/lecturers/jonathan.jpg'),
('Dr. Andreas Setiawan, D.Min.', 'Ketua Program Pascasarjana', 'Peneliti teologi kontekstual dan misi gereja di Indonesia.', '/images/lecturers/andreas.jpg');
