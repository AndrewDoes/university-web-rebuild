                ...
                <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <h1 className="text-4xl md:text-6xl font-black text-primary font-serif tracking-tighter uppercase leading-tight">
                                Halaman Sedang <br />{' '}
                                <span className="italic text-muted-foreground/40">Dalam Pengembangan</span>
                            </h1>
                        </div>
                        <p className="text-muted-foreground text-sm md:text-base italic leading-relaxed max-w-2xl mx-auto border-t border-border pt-6">
                            &ldquo;Kami sedang mempersiapkan konten terbaik untuk bagian ini guna memastikan setiap informasi yang Anda terima memiliki kualitas akademis dan teologis yang unggul.&rdquo;
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto pt-8">
                        ...
                        <div className="p-6 bg-card border border-border rounded-sm flex flex-col items-center gap-3">
                            ...
                            <span className="text-xs font-serif italic text-muted-foreground">In Progress</span>
                        </div>
                        <div className="p-6 bg-card border border-border rounded-sm flex flex-col items-center gap-3">
                            <Mail size={20} className="text-secondary" />
                            <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Contact Us</span>
                            <span className="text-xs font-serif italic text-muted-foreground">Available</span>
                        </div>
                    </div>
