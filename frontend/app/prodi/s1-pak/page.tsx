...
const graduateProfile = [
    {
        id: "informed",
        title: "Informed",
        description: "Pendidik Kristen yang berpengetahuan luas dan aplikatif terhadap tantangan perkembangan dunia pendidikan.",
        icon: <BookOpen size={28} />
    },
    {
        id: "transformed",
        title: "Transformed",
        description: "Pembelajar yang memiliki fondasi spiritualitas yang kokoh dan matang.",
        icon: <UserCheck size={28} />
    },
    {
        id: "transformative",
        title: "Transformative",
        description: "Pendidik Kristen yang berdampak bagi peserta didik dan lingkungan tempatnya melayani.",
        icon: <Zap size={28} />
    }
];
...
const curriculumCategories = [
    {
        ...
        sks: 12,
        items: [
            "Pancasila & Kewarganegaraan (2 SKS)",
    ...
    },
    {
        ...
        sks: 29,
        items: [
            "Studi PL 1-4 (Taurat, Sejarah, Sastra, Nabi-nabi)",
            "Studi PB 1-3 (Injil, Kisah & Surat Paulus, Surat Umum & Wahyu)",
    ...
    },
    {
        name: "Sejarah & Budaya",
        sks: 3,
        items: ["Sejarah & Filosofi Pendidikan Kristen (3 SKS)"]
    },
    {
        name: "Pendidikan & Praktika",
        sks: 65,
        items: [
            "Teologi Asuhan & Formasi Spiritualitas",
            "Homiletika & Pelayanan Ibadah",
            "Konseling Pastoral & Praktik Konseling Sekolah",
            "Pelayanan Anak, Kaum Muda, & Orang Tua Transformatif",
            "Psikologi & Teologi Pendidikan Kristen",
            "Integrasi Iman & Ilmu",
            "Kurikulum & Strategi Pembelajaran",
            "Micro Teaching 1 & 2 (6 SKS)"
        ]
    },
    {
        name: "Praktik Pelayanan",
        sks: 9,
        items: [
            "Praktik Pelayanan Misi (1 SKS)",
            "Praktik Pelayanan 1 Tahun (8 SKS)"
        ]
    },
    {
        name: "Tugas Akhir",
        ...
        items: [
            ...
            "Proyek: Merancang Program Pembinaan (4 SKS)"
        ]
    }
];

const S1PAKPage: React.FC = () => {
    const [activeTab, setActiveTab] = useState(4); // Default to Education/Praktika
                ...
                <div className="container mx-auto px-6 relative z-10 py-20">
                    <div className="max-w-4xl space-y-8">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-primary-foreground font-serif uppercase tracking-tighter leading-none">
                            Sarjana Pendidikan <br /> <span className="text-secondary italic">Kristen</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-8 pt-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-primary-foreground font-bold font-serif text-lg tracking-tight">Sarjana Pendidikan (S.Pd.)</p>
                                </div>
                            </div>
                            <div className="flex items-center space-x-3 border-l border-primary-foreground/10 pl-8">
                                ...
                                <div>
                                    ...
                                    <p className="text-primary-foreground font-bold font-serif text-lg tracking-tight">145 SKS</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <p className="text-primary-foreground/70 text-lg md:text-xl max-w-2xl leading-relaxed italic border-l-4 border-secondary pl-6">
                            "Mempersiapkan pendidik Kristen yang akan melayani di sekolah, gereja, maupun lembaga pelayanan lainnya dalam konteks urban."
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-24 bg-card border-b border-border">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-20 space-y-4">
                        ...
                        <h3 className="text-3xl md:text-4xl font-bold font-serif text-primary uppercase tracking-tighter">Profil Lulusan S.Pd</h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="bg-muted/50 p-8 border border-border rounded-sm space-y-4 shadow-sm">
                            ...
                            <p className="text-[13px] text-muted-foreground leading-relaxed">
                                4 tahun full time: 3 tahun perkuliahan kelas + 1 tahun praktik pelayanan komprehensif.
                            </p>
                        </div>
                        <div className="bg-muted/50 p-8 border border-border rounded-sm space-y-4 shadow-sm">
                            <div className="flex items-center space-x-3 text-primary">
                                <Users size={20} />
                                <h4 className="font-bold uppercase tracking-widest text-xs">Lingkup Praktik</h4>
                            </div>
                            <p className="text-[13px] text-muted-foreground leading-relaxed italic border-l-2 border-secondary/30 pl-4">
                                Mencakup sekolah Kristen, gereja, youth camp, serta MEET (Mission Education & Exposure Training).
                            </p>
                        </div>
                        <div className="bg-muted/50 p-8 border border-border rounded-sm space-y-4 shadow-sm">
                            <div className="flex items-center space-x-3 text-primary">
                            ...
                            <p className="text-[13px] text-muted-foreground leading-relaxed">
                                Mahasiswa yang belum menikah wajib tinggal di asrama untuk pembinaan karakter pendidik.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        <div className="lg:w-1/3 space-y-8 lg:sticky lg:top-32">
                            <div>
                                <h2 className="text-secondary font-bold tracking-[0.4em] uppercase text-xs mb-4">Informasi Akademik</h2>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-5xl mx-auto bg-primary text-primary-foreground rounded-sm overflow-hidden shadow-2xl flex flex-col lg:flex-row">
                        <div className="lg:w-1/2 p-12 lg:p-16 space-y-8 bg-primary relative">
                            <Presentation className="absolute -right-10 -bottom-10 w-64 h-64 text-primary-foreground/5 rotate-12 pointer-events-none" />
                            <div className="relative z-10">
                                <h3 className="text-3xl font-bold font-serif uppercase tracking-tighter mb-8 text-secondary">Syarat Admisi PAK</h3>
                                <ul className="space-y-6">
                                    {[
                                        ...
                                        "Memenuhi prosedur admisi yang berlaku di STTB."
                                    ].map((req, i) => (
                        ...
                        <div className="lg:w-1/2 p-12 lg:p-16 bg-card flex flex-col justify-center items-center text-center">
                            <h4 className="text-primary font-black font-serif text-3xl uppercase tracking-tighter mb-4">Siap Mendidik <br /> Generasi?</h4>
